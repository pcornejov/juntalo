...
var codeStatus = map[string]int{
	...
	"raffle_locked":              fiber.StatusUnprocessableEntity,
	"raffle_sold_out":            fiber.StatusConflict,
	"invalid_raffle_amount":      fiber.StatusUnprocessableEntity,
	...
	"invalid_google_token":       fiber.StatusUnauthorized,
	"google_email_not_verified":  fiber.StatusUnprocessableEntity,
}
